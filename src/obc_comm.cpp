...
uint8_t ack_MUA_to_OBC[TRAMA_COMM] = {0x26, 0x00, 0x00, 0xAA, 0xAA, 0x0A};            // MUA to OBC ACK: The CMD_ID is the received
const uint8_t nack_MUA_to_OBC[TRAMA_COMM] = {0x26, 0xFF, 0x00, 0xFF, 0xFF, 0x0A};     // INVALID CHECKSUM NACK: Constant for MUA
const uint8_t nack_IF_MUA_to_OBC[TRAMA_COMM] = {0x26, 0x00, 0x00, 0x00, 0x00, 0x0A};  // INVALID FRAME RECEIVED NACK: Constant for MUA
 ...
 * - Revisar cuando timeOUT_invalid_frame
 */
 ...
 *          Trama válida: 6 bytes, first → MUA_ID (0x26), last → STOP (0x0A)
 ...
 * @brief   Verifica el CRC y Mission IDs de la trama recibida, en un caso fallido se devuelve el NACK correspondiente
